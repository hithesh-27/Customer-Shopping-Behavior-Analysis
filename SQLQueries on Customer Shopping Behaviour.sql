...
--​Q2. Which customers used a discount but still spent the highest average purchase amount?
...
--​Q4. Compare the Average Purchase Amounts between Standard and Express Shipments.
select shipping_type,
ROUND(AVG(purchase_amount),2)
from customer
where shipping_type in ('Standard','Express')[[]]ppppppppppppppppppppppppppppppppppppppp
